          ...
          <div className="space-y-4 mb-8">
            ...
            >
              <div className="space-y-8">
                ...
                <div className="bg-gray-50 p-4 rounded-lg">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 text-sm">
                    ...
                    <div>
                      ...
                      <span className="ml-2 text-gray-600">{data.completeness_score}%</span>
                    </div>
                    <div>
                ...
                {/* DATA QUALITY NOTES */}
                <div>
                  <h3 className="text-lg font-semibold text-gray-900 mb-4">Data Quality Notes</h3>
                  <div>
                    <label className="block text-sm font-medium text-gray-700 mb-1">Internal Notes (Optional)</label>
                    <textarea
                      defaultValue={data.data_quality_notes || ''}
                      onChange={(e) => handleFieldChange('data_quality_notes', e.target.value || null)}
                      placeholder="Add any notes about data quality or verification status..."
                      rows={4}
                      maxLength={500}
                      className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                    />
